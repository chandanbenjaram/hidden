...
public class DotWallFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Cursor currDot = activity.getContentResolver().query(SchemaDots.CONTENT_URI, null, SchemaDots.COLUMN_UID + "=?", new String[]{dotUid}, null);
        int photoUrlIndex;
        if (currDot.moveToFirst()) {
            ...
            if (StringUtils.isNotBlank(user.getPhoto())) {
                ...
                backdropImg.setImageURI(Uri.parse(user.getPhoto()));
            }
        }
